            ...
            <form onSubmit={handleSubmit( e => submitForm(e))}>
              <div className="colums">
                <div className="item">
                  ...
                  <input id="name" type="text" name="pname" placeholder='Enter name of the patient' value={pname} {...register("pname", {required: true})} onChange={e =>handleChange(e)}/>  
                  <p style={{color:'red',fontSize:'13px'}}>{errors.pname?.type === "required" && "*Enter name"}</p>
                </div>
                <div className="item">
                  <label htmlFor="eaddress">Title<span>*</span></label>
                  <input id="title" type="text" name="title"  placeholder='Enter Title' value={title} {...register("title", {required: true})} onChange={e =>handleChange(e)}/>
                  <p style={{color:'red',fontSize:'13px'}}>{errors.title?.type === "required" && "*Enter Title"}</p>
                </div>
                <div className="item">
                  <label >Image<span>*</span></label>
                  <input type="file" id="image" name="pImage" placeholder='Select patient photo' value={pImage} {...register("pImage", {required: true})} onChange={e =>handleChange(e)}/>
              ...
              <div className="item">
                ...
                <textarea id="visit" rows={3} name="discrip" style={{boxshadow:'2px 2px 5px rgba(0, 0, 0, 0.5)'}} value={discrip} {...register("discrip", {required: true})} onChange={e =>handleChange(e)}/>
