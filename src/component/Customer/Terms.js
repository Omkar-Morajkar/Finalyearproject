...
return (
    ...
    <div className="d-flex flex-column justify-content-center align-items-center" style={{ width: '80%', background:'#e9ecef', borderRadius: '20px', border: '1px solid black', padding: '20px',boxShadow:' 0px 10px 10px rgba(0, 0, 0, 0.5)' }}>
      ...
      <p>Disclaimer
We do not provide any financial return in any form whatsoever, including but not limited to financial securities (debt or equity), interest, dividend, profit share, rewards in cash, to individuals who contribute on Fund_peti.com.
Any contribution on fund_peti.com, by an individual, should not be construed as an investment in any form whatsoever.
Terms of use
Fund_peti.com, a platform for giving and philanthropic donation webapp.
...
Finally, we encourage you, particularly if you intend to donate to a Milaap campaign or raise funds for a need, to review the Pricing section of these Terms of Service.
