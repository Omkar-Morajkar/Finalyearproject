...
function Verification() {
  ...
  const submitForm = async(e) =>{
    ...
    await axios.post("http://localhost/finalYearProject/verification.php",fd)
    .then((respo)=>{
      console.log(respo);
            ...
            <form action="/" onSubmit={handleSubmit( e => submitForm(e))} style={{borderRadius:"20px",marginTop:"20px",marginBottom:'20px',background:'#e9ecef',boxShadow:'0px 5px 10px 0px rgba(0, 0, 0, 0.3)'}}>
              <div className="colums">
                ...
                <div className="item">
                    ...
                    <input type="text" id="form3Example4cd" name="bank" className="form-control" placeholder="Enter Patient Bank Acc"  {...register("bank", {required: true})} onChange={e =>handleChange(e)}/>
                    <p style={{color:'red',fontSize:'13px'}}>{errors.bank?.type === "required" && "*Enter patient bank account number"}</p>
                </div>

                <div className="item">
                    <label>Amount:</label>
                    <input type="text" id="form3Example4cd" name="amount"  className="form-control" placeholder="Enter Amount needed" {...register("amount", {required: true})} onChange={e =>handleChange(e)}/>
                ...
                <div className="item">
                    ...
                    <select id="stage" name='stage'style={{width:'100%',height:'50%'}} {...register("stage", {required: true})} onChange={e =>handleChange(e)}>
                ...
                <div className="item">
                    ...
                    <input name="Mrecord" type="file" className="form-control"  placeholder="Add Patient's Medical History"  {...register("Mrecord", {required: true})} onChange={e =>handleChange(e)}/>
                    <p style={{color:'red',fontSize:'13px'}}>{errors.Mrecord?.type === "required" && "*Enter Medical Records "}</p>
                </div>

                <div className="item">
                    <label>Background Story:</label>
                    <input name="Bstory" type="file" className="form-control"  accept="image/jpeg,image/jpg,image/png,application/pdf,image/x-eps"  placeholder="Add the reason behind the Patient's ailment" {...register("Bstory", {required: true})} onChange={e =>handleChange(e)} />
