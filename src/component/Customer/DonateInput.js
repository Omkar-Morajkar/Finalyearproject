        ...
        <>
         <div id='Login'>
          ...
          <div className="testbox" style={{marginLeft:'200px',marginRight:'200px',marginTop:"50px",marginBottom:"50px"}}>
            <form onSubmit={handleSubmit( e => submitForm(e)) }style={{borderRadius:'20px'}}  encType="multipart/form-data">
              <div className="colums">
                ...
                <div className="item">
                  ...
                  <input type="file" id="pImage" name="pImage" placeholder='Select patient photo' {...register("pImage", {required: true})} onChange={e =>handleChange(e)}/>
